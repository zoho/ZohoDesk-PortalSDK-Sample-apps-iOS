...
install_xcframework "${PODS_ROOT}/ZohoDeskPortalChat/ZohoDeskPortalChat.xcframework" "ZohoDeskPortalChat" "framework" "ios-arm64_armv7" "ios-i386_x86_64-simulator"
