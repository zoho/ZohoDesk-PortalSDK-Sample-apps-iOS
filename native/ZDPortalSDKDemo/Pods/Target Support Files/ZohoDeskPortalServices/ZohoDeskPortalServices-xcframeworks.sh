...
install_xcframework "${PODS_ROOT}/ZohoDeskPortalServices/ZohoDeskPortalServices.xcframework" "ZohoDeskPortalServices" "framework" "ios-i386_x86_64-simulator" "ios-arm64_armv7"
