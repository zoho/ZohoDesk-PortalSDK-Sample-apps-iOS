...
install_xcframework "${PODS_ROOT}/ZohoDeskPortalTicket/ZohoDeskPortalTicket.xcframework" "ZohoDeskPortalTicket" "framework" "ios-arm64_armv7" "ios-i386_x86_64-simulator"
