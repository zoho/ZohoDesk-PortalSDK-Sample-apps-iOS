...
install_xcframework "${PODS_ROOT}/ZohoDeskPortalCommunity/ZohoDeskPortalCommunity.xcframework" "ZohoDeskPortalCommunity" "framework" "ios-i386_x86_64-simulator" "ios-arm64_armv7"
