...
install_xcframework "${PODS_ROOT}/ZohoDeskPortalAPIKit/ZohoDeskPortalAPIKit.xcframework" "ZohoDeskPortalAPIKit" "framework" "ios-i386_x86_64-simulator" "ios-arm64_armv7"
