...
install_xcframework "${PODS_ROOT}/ZohoDeskPortalCore/ZohoDeskPortalCore.xcframework" "ZohoDeskPortalCore" "framework" "ios-arm64_armv7" "ios-i386_x86_64-simulator"
