...
install_xcframework "${PODS_ROOT}/ZohoDeskPortalConfiguration/ZohoDeskPortalConfiguration.xcframework" "ZohoDeskPortalConfiguration" "framework" "ios-arm64_armv7" "ios-i386_x86_64-simulator"
